"""
SFT Data Construction - MinHash Deduplication

This script implements MinHash-based deduplication for SFT data.
Based on the paper: First stage of three-stage quality filtering.
...
def main():
    parser = argparse.ArgumentParser(description="MinHash Deduplication")
    ...
    deduped_df.to_parquet(args.output, index=False)
